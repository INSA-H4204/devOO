...
/**
 * Classe qui gere les boutons charger plan, charger livraison, charger tournee,
 * Impression et la Legende
 * 
 * @author gabrielcae
 * 
 */
public class VuePlageHoraire extends JPanel {
	...
	/**
	 * Methode qui definit et construit la VuePlageHoraire
	 */
	public void chargerVuePlageHoraire() {
		...
		jPanelLegende.setLayout(new BoxLayout(jPanelLegende,
				BoxLayout.LINE_AXIS));
	...
	/**
	 * Surcharge de la methode qui paint le panel legende
	 */
