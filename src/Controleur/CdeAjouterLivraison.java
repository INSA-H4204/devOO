...
public class CdeAjouterLivraison extends Commande {
	...
	/**
	 * Noeud qui precede le noeud à ajouter dans la tournee
	 */
	private Noeud noeudPrecedent;
	
	/**
	 * Noeud selectionne pour etre ajoute
	 */
	private Noeud noeudSelectionne;
	
	/**
	 * ID du client de la livraison a ajouter
	 */
	private int idClient;
	
	/**
	 * Plage horaire de la livraison a ajouter
	 */
	private PlageHoraire plage;

	/**
	 * Constructeur par defaut de la classe CdeAjouterLivraison
	 * 
	 * @author hgerard
	 */
	 ...
	 * @author hgerard
	 */
	public CdeAjouterLivraison(Zone zone, Noeud noeudPrecedent,
			Noeud noeudSelectionne, int idClient) {
	...
	/**
	 * Fonction appelée quand on execute la fonction normalement Elle ajoute une
	 * livraison dans la zone, l'insère dans une tournée et recalcule les
	 * chemins à recalculer
	 * 
	 * @author thelmer
	 */
	public void execute() {
	...
	/**
	 * Fonction appelee quand on annule la fonction
	 * 
	 * @author hgerard
	 */
	public void undo() {
